...
exports.tex_final_end =
  ...
  exports.rewrite =
  exports.reset =
  exports.printNewline =
  exports.printFloat =
  exports.printInteger =
  exports.printChar =
  exports.printBoolean =
  exports.printString =
  exports.getCurrentYear =
  exports.getCurrentMonth =
  exports.getCurrentDay =
  exports.getCurrentMinutes =
  exports.executeAsync =
  exports.setFileLoader =
  exports.setInput =
  exports.setMemory =
  exports.setShowConsole =
  exports.readFileSync =
  exports.writeFileSync =
  exports.deleteEverything =
  exports.pages =
    void 0;
...
function openSync(filename, mode) {
  ...
  if (filesystem[filename]) {
    ...
    buffer = Uint8Array.from(
      (0, dvi2html_1.tfmData)(filename.replace(/\.tfm$/, "")),
    );
  } else if (mode == "r") {
    ...
    let descriptor = files.findIndex(
...
function inputln(
  ...
  if (file.position2 >= file.content.length) {
    ...
    buffer
      .subarray(first[0])
      .set(file.content.subarray(file.position2, endOfLine));
