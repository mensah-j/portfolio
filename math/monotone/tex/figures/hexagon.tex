...
\caption{A hexagon which is not monotone with respect to any direction. Lines through the centroid $q$ may be shifted to intersect the boundary in more than two points.}
\label{fig:hexagon}
\end{figure}
